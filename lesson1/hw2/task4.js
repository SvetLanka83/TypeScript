...
console.log(usersHG[0].password);
console.log(usersHG[1].password);
console.log(usersHG[2].password);
console.log(usersHG[3].password);
console.log(usersHG[4].password);
console.log(usersHG[5].password);
console.log(usersHG[6].password);
console.log(usersHG[7].password);
console.log(usersHG[8].password);
console.log(usersHG[9].password);
